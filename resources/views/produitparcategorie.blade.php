   ...
   <div style="background-color: rgb(246, 246, 244)" class="row px-5 ">
    ...
    <div class="col ms-2 me-4 pt-4">
      <div style="background-color: rgb(206, 204, 204)">
        <div class="border ps-3 bg-dark rounded text-white h5 py-2">Accueil / {{$categorie->nom}}</div>
        <div class=" ps-3 py-2 h4" >{{$categorie->nom}}</div>
          ...
          <div class="card " style="width: 18rem;">
            <ul class="list-group list-group-flush">
              <li class="list-group-item p-5">
                {{-- <img src="{{asset('front_end/images/feature1.PNG')}}" alt="" height="150" width="200">
                 --}}
              ...
              <li class="list-group-item">
                ...
                <div class="d-flex gap-2">
                  <a href="{{route('addBook.to.cart', $produit->id)}}" class="btn btn-success">Add to cart</a>
