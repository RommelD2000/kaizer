                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        290.290Fcfa has been deposited into your account!
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                         ...
                                         <div class="accordion-item">
                                          <h2 class="accordion-header" id="headingOne">
                                            <button class="accordion-button col" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne{{$commande->id}}" aria-expanded="true" aria-controls="collapseOne">
                                                  {{-- <a href="{{route('liste_commandes_par_client', ['id', $commande->id])}}"> </a>--}}
                                                    <span class="col-6 "> Commande de <span class="h5">{{$commande->user->name}}</span> du  {{$commande->created_at}}</span>
                                            ...
                                            <div class="accordion-body">
                                                <div class="pt-3">
                                                  ...
                                                  <div class="d-flex justify-content-end">
                                                    <span class=" text-end pe-5 text-end">  
                                                        <span>Valider la commande: </span>
                                                        <a class="btn btn-success" href="{{route('valider', ['id' => $commande->id])}}">
